...
//     { id: 1, company: '', startDate: '', endDate: '', companyLink: '', jobType: '', title: '', location: '', description: '' },
//   ]);

//   const addWorkExperienceField = () => {
//     setWorkExperienceFields([
//       ...workExperienceFields,
//       { id: workExperienceFields.length + 1, company: '', startDate: '', endDate: '', companyLink: '', jobType: '', title: '', location: '', description: '' },
//     ]);
//   };
...
//           </TouchableOpacity>
//           <Button title="Save" onPress={() => console.log(workExperienceFields)} />
//         </ScrollView>
//       </View>
//     </SafeAreaProvider>
//   );
...
const WorkExperience = ({ navigation }) => {
  ...
  const saveDetails = async () => {
    ...
    try {
      // Assuming you have an action in your profileSlice to update work experience data
     // dispatch(setProfile({ workExperience: updatedWorkExperienceFields }));
