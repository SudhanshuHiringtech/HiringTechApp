  ...
  return (
    ...
    >
      <ScrollView contentContainerStyle={styles.sheetContent}>
        ...
        <View style={styles.buttonGroup}>
          {call == 'Internship' ? (level) : (experience).map(level => (
            <TouchableOpacity
              key={level}
        ...
        { call !== 'jobs' ? (
        <><Text style={styles.subtitle}>Job offer attached</Text><Switch
                      value={filterData.isJobOfferAttached}
                      onValueChange={(value) => setFilterData(prevData => ({ ...prevData, isJobOfferAttached: value }))} /></> ) : null
        }
       
        { call === 'Internship'  ? ( 
         <><Text style={styles.subtitle}>Min. Stipend</Text><View style={styles.sliderLabels}>
                      <Text>0</Text>
                      <Text>10K</Text>
                      <Text>20K</Text>
                      <Text>30K</Text>
             ...
             <><Text style={styles.subtitle}>Min. Salary</Text><View style={styles.sliderLabels}>
                          <Text>3 LPA</Text>
                          <Text>5 LPA</Text>
                          <Text>9 LPA</Text>
                          <Text>14 LPA</Text>
       ...
       { call !== 'jobs' ?  (
        <><Text style={styles.subtitle}>Max Duration (in Months)</Text><View style={styles.sliderLabels}>
                      <Text>1M</Text>
                      <Text>2M</Text>
                      <Text>3M</Text>
                      <Text>6M</Text>
                      <Text>12M</Text>
                          ...
                          step={1}
                          thumbTintColor="#FFA500"
                          minimumTrackTintColor="#FFA500" /><Text>{filterData.maxDuration}M</Text></>
       ): null}
